...
--[[local gioChair = createObject(1369, 2442.44140625, -2533.6845703125, 5095.03, 0, 0, 312.97503662109)
	...
	exports.anticheat:changeProtectedElementDataEx(giovanna, "rotation", getPedRotation(giovanna), false)
	exports.anticheat:changeProtectedElementDataEx(giovanna, "name", "Giovanna Remini")
	exports.anticheat:changeProtectedElementDataEx(giovanna, "activeConvo",  0)
	exports.anticheat:changeProtectedElementDataEx(giovanna,"talk",true)
	doneDeals = 0
	exports.anticheat:changeProtectedElementDataEx( getRootElement( ), "gio.done", 0, false )
		...
		if (allowance) and (allowance == "no")  then
			...
			if (stage == 1) then
				...
				if (factionLeader == 0) then
					...
					exports.anticheat:changeProtectedElementDataEx (giovanna, "activeConvo",  1)
					talkingToGio = source
