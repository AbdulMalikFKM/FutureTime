...
exports.anticheat:changeProtectedElementDataEx(hunter, "rotation", getPedRotation(hunter), false)
...
exports.anticheat:changeProtectedElementDataEx (hunter, "activeConvo",  0) -- Set the convo state to 0 so people can start talking to him.
exports.anticheat:changeProtectedElementDataEx(hunter, "name", "Hunter")
exports.anticheat:changeProtectedElementDataEx(hunter, "talk", true)
...
function hunterIntro () -- When player enters the colSphere create GUI with intro output to all local players as local chat.
	...
	if(getElementData(hunter, "activeConvo")==1)then
		...
		if(huntersFriend==1)then -- If they are already a friend.
			...
			exports.anticheat:changeProtectedElementDataEx (hunter, "activeConvo", 1) -- set the NPCs conversation state to active so no one else can begin to talk to him.
...
function resetHunterConvoState()
	exports.anticheat:changeProtectedElementDataEx(hunter, "activeConvo", 0)
end
