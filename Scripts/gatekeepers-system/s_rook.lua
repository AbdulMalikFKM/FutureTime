...
exports.anticheat:changeProtectedElementDataEx (rook, "activeConvo",  0) -- Set the convo state to 0 so people can start talking to him.
exports.anticheat:changeProtectedElementDataEx(rook, "name", "Rook")
exports.anticheat:changeProtectedElementDataEx(rook, "talk", true)
exports.anticheat:changeProtectedElementDataEx(rook, "rotation", getPedRotation(rook), false)
	...
	if(getElementData( rook, "activeConvo" )==1)then
		...
		if not(factionType==0) or factionLeader==0 then
			...
			--else -- If they are not a friend.
				...
				exports.anticheat:changeProtectedElementDataEx (rook, "activeConvo", 1) -- set the NPCs conversation state to active so no one else can begin to talk to him.
...
function resetRookConvoState()
	exports.anticheat:changeProtectedElementDataEx(rook,"activeConvo", 0)
end
