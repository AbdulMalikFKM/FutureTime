...
function createStevie()
	...
	exports.anticheat:changeProtectedElementDataEx(stevie, "name", "Steven Pullman")
	exports.anticheat:changeProtectedElementDataEx(stevie, "deals", 0) -- reset how many deals he has made today. Stevie will do 5 deals over the phone each day. He can't be called while he is in the game world (19:00-22:00).
	exports.anticheat:changeProtectedElementDataEx(stevie,"talk",true) -- allows the player to right click on him.
	doneDeals = { }
	exports.anticheat:changeProtectedElementDataEx( getRootElement( ), "stevie.done", { }, false )
...
function stevieIntro (thePlayer) -- When player enters the colSphere create GUI with intro output to all local players as local chat.
	...
	if(getElementData(stevie, "activeConvo")==1)then
		...
		exports.anticheat:changeProtectedElementDataEx (stevie, "activeConvo", 1, false) -- set the NPCs conversation state to active so no one else can begin to talk to him.
...
function resetStevieConvoState()
	exports.anticheat:changeProtectedElementDataEx(stevie,"activeConvo", 0, false)
end
			...
			if not exports.donators:hasPlayerPerk(thePlayer, 6) and not exports.global:hasMoney(thePlayer, 10) then
				...
				if(stevie)then -- If stevie is currently spawned (i.e., if it's between 1900 and 2200).   -- disabled while testing.
					...
					if (phoneState==1) then -- is someone already speaking to stevie?
						...
						phoneState = 1
						exports.anticheat:changeProtectedElementDataEx(thePlayer, "calling", "stevie", false)
...
function acceptDeal_S( dealNumber )
	...
	elseif stevieMarker then
		...
		exports.anticheat:changeProtectedElementDataEx( getRootElement( ), "stevie.done", doneDeals, false )
		...
		exports.anticheat:changeProtectedElementDataEx(stevieCol, "dealNumber", dealNumber, false)
		exports.anticheat:changeProtectedElementDataEx(source, "stevie.money", cost, false)
...
function giveGoods(thePlayer)
	...
	elseif not exports.global:hasSpaceForItem(veh) then
		...
		exports.anticheat:changeProtectedElementDataEx(thePlayer, "stevie.money", false, false)
...
function endCall(thePlayer) -- to cancel the phone animation and reset the phone states.
	...
	toggleAllControls(thePlayer, true, true, true)
	exports.anticheat:changeProtectedElementDataEx(thePlayer, "calling")
