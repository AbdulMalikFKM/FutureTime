...
exports.anticheat:changeProtectedElementDataEx (tyrese, "activeConvo",  0) -- Set the convo state to 0 so people can start talking to him.
exports.anticheat:changeProtectedElementDataEx(tyrese, "name", "Ty")
exports.anticheat:changeProtectedElementDataEx(tyrese, "talk", true)
exports.anticheat:changeProtectedElementDataEx(tyrese, "rotation", getPedRotation(tyrese), false)
...
function tyIntro () -- When player enters the colSphere create GUI with intro output to all local players as local chat.
	...
	if(factionType ~= 0 or getElementData( tyrese, "activeConvo" )==1)then
		...
		if factionLeader == 0 then
			...
			exports.anticheat:changeProtectedElementDataEx (tyrese, "activeConvo",  1)
			talkingToTy = source
...
function tyStatement4_S()
	...
	exports.anticheat:changeProtectedElementDataEx (tyrese, "activeConvo",  0)
