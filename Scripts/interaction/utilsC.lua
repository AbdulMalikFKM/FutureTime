...
-- the efect settings
--local colorizePed = {255 / 255, 198 / 255, 0 / 255, 1} -- Yellow
--local colorizePed = {50 / 255, 179 / 255, 239 / 255, 1} -- Blue
local colorizePed = {0 / 255, 163 / 255, 255 / 255, 1} -- Blue
...
function drawScrollbar(key, x, y, w, h, visibleItems, currentItems)
    ...
    dxDrawImage(x, trackY - w, w, w, "icons/arrow.png", 0, 0, 0, colorOfArrow)
    ...
    dxDrawImage(x, trackY + trackHeight, w, w, "icons/arrow.png", 180, 0, 0, colorOfArrow)
...
function drawButtonSlider(key, state, x, y, h, offColor, onColor)
    ...
    dxDrawImage(x, y, 64, 32, "toggleSwitch/off.png", 0, 0, 0, tocolor(255, 255, 255, (255 - alphaDifference) * fadeAmount))
    dxDrawImage(x, y, 64, 32, "toggleSwitch/on.png", 0, 0, 0, tocolor(buttonColor[1], buttonColor[2], buttonColor[3], alphaDifference * fadeAmount))
    dxDrawImage(x + buttonSlider.offsets[key], y, 64, 32, "toggleSwitch/circle.png", 0, 0, 0, tocolor(255, 255, 255, 255 * fadeAmount))
end
