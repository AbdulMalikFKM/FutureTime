...
function quitJob(job)
	...
	elseif (job==8) then -- storekeeper
		outputChatBox("You have now quit your job as a Storekeepers.", 0, 255, 0)
		elseif (job==9) then -- window cleaner
		outputChatBox("You have now quit your job as a Window Cleaner.", 0, 255, 0)
	end
end
