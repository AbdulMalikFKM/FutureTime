...
addEventHandler( "onClientResourceStart", resourceRoot, night_init )
addEvent("accounts:settings:graphic_shader_darker_night", false)
addEventHandler( "accounts:settings:graphic_shader_darker_night", root, night_init )
